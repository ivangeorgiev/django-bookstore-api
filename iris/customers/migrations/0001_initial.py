    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT, to='customers.addressstatus')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='customer',
            name='addresses',
            field=models.ManyToManyField(related_name='customers', through='customers.CustomerAddress', to='customers.address'),
        ),
        migrations.AddField(
            model_name='address',
            name='country',
